// Atualize o ContactMap.tsx para:
...
const ContactMap: React.FC<ContactMapProps> = ({ selectedOffice = "South" }) => {
  // Substitua esta chave pela sua chave real da API do Google Maps
  const apiKey = "AIzaSyDnjSgKXYaTWu99-KVVC_zWmKOCE3Cn_RQ"; 
  
  return <GoogleMapsContact apiKey={apiKey} initialSelectedOffice={selectedOffice} />;
};
